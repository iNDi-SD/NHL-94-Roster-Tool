...
class Ui_statExtract(object):
    def setupUi(self, statExtract):
        ...
        self.typeGens = QtWidgets.QRadioButton(self.centralwidget)
        self.typeGens.setObjectName("typeGens")
        self.stateTypeLayout.addWidget(self.typeGens)
    ...
    def retranslateUi(self, statExtract):
        ...
        self.typeGens.setText(_translate("statExtract", "Gens"))
